...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DD_RUN_AGENT` | Use this option to control whether or not to run the datadog-agent. If set to `false`, a DogStatsD server will be started instead. Default: `true` |
